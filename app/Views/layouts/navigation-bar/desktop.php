<nav uk-sticky>
    <div class="nav-wrapper" style="height: 66px !important;">
        ...
        <a class=" uk-button uk-hidden@m waves-effect waves-light uk-text-decoration-none" style=" background-color: rgb(112, 128, 144, 0.15);" uk-toggle="target: #offcanvas-reveal">
