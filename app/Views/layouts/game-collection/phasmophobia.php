  ...
  <div id="phasmophobia">
      <div class="uk-card uk-card-hover uk-card-default uk-border-rounded">
          <div class="uk-card-media-top">
              <img src="/img/phasmophobia-title-10-21-2020.jpg" alt="" height="" width="100%" uk-img>
          </div>
          <div class="uk-card-body">
              ...
              <ul class="uk-list-disc">
                  ...
                  <li>
                      <p>Dirilis :
                          <a href="" class="uk-button-text uk-button-link uk-border-rounded" rel="noreferrer" target="_blank">
                              2020
                          </a>
                      </p>
                  </li>
              ...
              <p uk-margin>
                  <a href="https://store.steampowered.com/app/739630/Phasmophobia/" class="uk-button uk-margin-right light-blue darken-2 waves-effect waves-light" style="color:white;" rel="noreferrer" target="_blank">
